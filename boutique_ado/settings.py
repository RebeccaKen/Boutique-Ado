...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutique-ado-e-commerce-5'
    ...
    STATIC_URL = f'https://{boutique-ado-e-commerce-5}.s3.{eu-west-1}.amazonaws.com/{STATICFILES_LOCATION}/'
    MEDIA_URL = f'https://{boutique-ado-e-commerce-5}.s3.{eu-west-1}.amazonaws.com/{MEDIAFILES_LOCATION}/'
